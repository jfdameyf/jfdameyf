...
class TradingBotBacktester:
    def __init__(self, start_date, end_date, enable_poc_filter=False,
        ...
        # Try to initialize orderbook analyzer if API key is available
        if API_KEY and "YOUR_DATABENTO" not in API_KEY:
            try:
    ...
    def generate_report(self):
        ...
        if not df_trades.empty:
            ...
            if 'entry_resting_liquidity' in df_trades.columns and df_trades['entry_resting_liquidity'].notna().any():
                ...
                print(f"\n📊 ENTRY DEPTH QUALITY:")
                if 'entry_depth_quality' in df_trades.columns:
                ...
                if 'entry_imbalance' in df_trades.columns:
                ...
                if 'entry_resting_liquidity' in df_trades.columns:
