"""
NQ Trading Bot - Parameter Optimization Tool
...
# Import NQ backtester
from backtest_bot_NQ_COMPLETE import TradingBotBacktester
...
class ParameterOptimizer:
    def __init__(self, start_date, end_date, enable_poc_filter=False):
        ...
        print(f"🔬 NQ PARAMETER OPTIMIZER INITIALIZED")
        print(f"   Period: {start_date} to {end_date}")
        print(f"   POC Filter: {enable_poc_filter}\n")

    def run_optimization(self,
                        cooldown_options=[15, 30, 45, 60, 90, 120],
                        target_options=[8.0, 10.0, 12.0, 15.0, 20.0, 25.0],
                        stop_options=[4.0, 6.0, 8.0, 10.0, 12.0, 15.0]):
        """
        Run grid search optimization for NQ
        ...
        print(f"🔄 STARTING NQ GRID SEARCH OPTIMIZATION")
        ...
        for idx, (cooldown, target, stop) in enumerate(combinations, 1):
            ...
            try:
                ...
                if backtester.trades:
                    ...
                    expectancy = avg_pnl * 20  # NQ: $20/point
        ...
        print(f"\n{'='*80}")
        print(f"✅ NQ OPTIMIZATION COMPLETE")
    ...
    def analyze_results(self):
        ...
        print(f"📊 NQ OPTIMIZATION RESULTS")
        print("="*80)
        ...
        print(f"\n{'='*80}")
        print(f"🏆 RECOMMENDED NQ CONFIGURATION")
        print(f"{'='*80}")
...
# ==============================================================================
# PRESET OPTIMIZATION PROFILES (NQ)
# ==============================================================================

def quick_optimize(days_back=30, enable_poc=False):
    """
    Quick NQ optimization with common parameter ranges
...
def comprehensive_optimize(days_back=30, enable_poc=False):
    """
    Comprehensive NQ optimization (takes longer)
...
def custom_optimize(days_back=30, enable_poc=False,
    ...
    """
    Custom NQ optimization with user-defined ranges
    ...
    # Use defaults if not provided (NQ-appropriate)
...
if __name__ == "__main__":
    print("="*80)
    print("   NQ TRADING BOT - PARAMETER OPTIMIZATION")
    print("="*80)
    ...
    if choice == "1":
        print("\n🔬 Running Quick NQ Optimization (30 days)...")
        quick_optimize(days_back=30, enable_poc=enable_poc)

    elif choice == "2":
        print("\n🔬 Running Comprehensive NQ Optimization (30 days)...")
        ...
        print(f"\n🔬 Running Custom NQ Optimization ({total_combos} combinations)...")
