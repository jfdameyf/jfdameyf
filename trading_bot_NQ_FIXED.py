...
SIGNAL_LOG_FILE = f"{LOG_DIR}/nq_signals_{datetime.now().strftime('%Y%m%d')}.csv"
...
class LiveBot:
    ...
    def send_discord_alert(self, price, order_type, direction, size_mod, message, timestamp):
        ...
        embed = {
            "title": f"🚀 {direction_emoji} NQ {direction} SIGNAL",
            ...
            "footer": {"text": "NQ Trading Bot • Live Signal"}
        }
