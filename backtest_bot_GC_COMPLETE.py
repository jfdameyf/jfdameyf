"""
GC Trading Bot Backtester - COMPLETE VERSION
...
# Import from GC bot
from trading_bot_GC_FIXED import StrategyManager, MarketPlanner
...
# ==============================================================================
# BACKTESTER WITH MFE/MAE ANALYSIS (GC)
# ==============================================================================
class TradingBotBacktester:
    def __init__(self, start_date, end_date, enable_poc_filter=False,
                 signal_cooldown_minutes=60, target_points=4.0, stop_points=2.0):
        """
        Initialize GC backtester with trade outcome analysis
        ...
        print(f"🔬 GC BACKTESTER INITIALIZED (COMPLETE VERSION)")
    ...
    def generate_historical_plans(self):
        ...
        print("📅 Generating Historical GC Plans...")
        print("="*60)
        ...
        while current <= self.end_date:
            ...
            try:
                ...
                with open('gc_daily_context.json', 'r') as f:
                    data = json.load(f)
                    if plan_key in data:
        ...
        print("\n" + "="*60)
        print(f"✅ Generated {len(self.daily_plans)} daily GC plans\n")

    def run_backtest(self):
        """Main backtesting loop - replays historical data with trade analysis"""
        print("🔄 Running GC Backtest with Trade Analysis...")
        print("="*60 + "\n")
    ...
    def _evaluate_bar(self, strategy, current_price, timestamp, plan):
        ...
        signals = []
        scan_range = 80.0  # GC: 80pts (ES was 20pts)
    ...
    def _calculate_trade_outcome(self, signal, bars, entry_idx, entry_time):
        """
        Calculate MFE/MAE and trade outcome for GC
        ...
        return {
            ...
            'mae': round(mae, 2),
            'pnl': round(pnl, 2),
            'pnl_ticks': round(pnl * 4, 0),  # GC = $20/point = $5/tick
            'outcome': outcome,
    ...
    def plot_results(self):
        ...
        fig.suptitle(f'GC Backtest Results: {self.start_date} to {self.end_date}',
    ...
    def run_full_backtest(self):
        ...
        print("\n" + "="*60)
        print("🚀 STARTING FULL GC BACKTEST WITH TRADE ANALYSIS")
        print("="*60 + "\n")
...
def quick_backtest(days_back=7, enable_poc=False, cooldown_minutes=60,
    ...
    """Quick GC backtest with trade analysis"""
...
if __name__ == "__main__":
    print("="*60)
    print("   GC TRADING BOT BACKTESTER (COMPLETE)")
    print("="*60)
    ...
    if choice == "1":
        print(f"\n🔬 Running 7-Day GC Backtest...")
        quick_backtest(7, enable_poc, cooldown, target, stop)

    elif choice == "2":
        print(f"\n🔬 Running 30-Day GC Backtest...")
