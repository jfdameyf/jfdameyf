"""
ES Trading Bot - Parameter Optimization Tool
...
class ParameterOptimizer:
    ...
    def run_optimization(self,
                        cooldown_options=[5, 10, 15, 30, 45, 60],
                        target_options=[3.0, 4.0, 5.0, 6.0, 8.0, 10.0],
                        stop_options=[1.5, 2.0, 2.5, 3.0, 4.0, 5.0]):
        """
        ...
        for idx, (cooldown, target, stop) in enumerate(combinations, 1):
            ...
            try:
                ...
                if backtester.trades:
                    ...
                    expectancy = avg_pnl * 50  # Convert to dollars
                    ...
                    result = {
                        ...
                        'total_pnl_dollars': round(total_pnl * 50, 0),
                    ...
                    print(f"   ✅ Trades: {total_trades}, WR: {win_rate:.1f}%, P&L: ${total_pnl*50:.0f}, Exp: ${expectancy:.0f}")
...
def quick_optimize(days_back=30, enable_poc=False):
    ...
    optimizer.run_optimization(
        cooldown_options=[10, 20, 30, 45],
        target_options=[4.0, 5.0, 6.0, 8.0],
        stop_options=[2.0, 2.5, 3.0]
    )
...
def comprehensive_optimize(days_back=30, enable_poc=False):
    """
    Comprehensive optimization (takes longer)
    ...
    optimizer.run_optimization(
        cooldown_options=[5, 10, 15, 20, 30, 45, 60],
        target_options=[3.0, 4.0, 5.0, 6.0, 8.0, 10.0],
        stop_options=[1.5, 2.0, 2.5, 3.0, 4.0]
    )
...
def custom_optimize(days_back=30, enable_poc=False,
    ...
    """
    Custom optimization with user-defined ranges
    ...
    if cooldowns is None:
        cooldowns = [10, 20, 30, 45]
    if targets is None:
        targets = [4.0, 5.0, 6.0, 8.0]
    if stops is None:
        stops = [2.0, 2.5, 3.0]
...
if __name__ == "__main__":
    print("="*80)
    print("   ES TRADING BOT - PARAMETER OPTIMIZATION")
    print("="*80)
    print("\n1. Quick Optimize (48 combinations, ~10 mins)")
    print("   Cooldowns: 10, 20, 30, 45 min")
    print("   Targets: 4, 5, 6, 8 pts")
    print("   Stops: 2, 2.5, 3 pts")
    print("\n2. Comprehensive Optimize (~150 combinations, ~30 mins)")
    print("   Cooldowns: 5, 10, 15, 20, 30, 45, 60 min")
    print("   Targets: 3, 4, 5, 6, 8, 10 pts")
    print("   Stops: 1.5, 2, 2.5, 3, 4 pts")
    ...
    if choice == "1":
        print("\n🔬 Running Quick Optimization (30 days)...")
        quick_optimize(days_back=30, enable_poc=enable_poc)

    elif choice == "2":
        print("\n🔬 Running Comprehensive Optimization (30 days)...")
        ...
        cooldown_input = input("Cooldowns (minutes) [10,20,30,45]: ").strip()
        target_input = input("Targets (points) [4,5,6,8]: ").strip()
        stop_input = input("Stops (points) [2,2.5,3]: ").strip()
        ...
        print(f"\n🔬 Running Custom Optimization ({total_combos} combinations)...")
